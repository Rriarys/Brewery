    ...
    {   
        ...
        host.UseSerilog((context, loggerConfiguration) => 
        {
            loggerConfiguration
                ...
                .MinimumLevel.Override("Microsoft.AspNetCore", LogEventLevel.Warning) // WARNING level for ASP.NET Core logs to focus on potential issues while still capturing important events
